                ...
                <CardContent>
                  ...
                  >
                    <BarChart data={chartData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                      ...
                      <Bar animationDuration={3000} animationEasing="linear" dataKey="repasse" stackId="a" fill="hsl(142 71% 45%)" radius={[0, 0, 0, 0]}/>
                      <Bar animationDuration={3000} animationEasing="linear" dataKey="comissao" stackId="a" fill="hsl(25 95% 53%)" radius={[4, 4, 0, 0]}/>
                    </BarChart>
                  </ChartContainer>
                </CardContent>
              </Card>
