          ...
          <CardContent>
            <ChartContainer config={{ novos: { label: "Novos", color: "hsl(25 95% 53%)" } }} className="h-[220px] w-full">
              <AreaChart data={chartData} margin={{ top: 5, right: 10, bottom: 0, left: -10 }}>
                ...
                <Area animationDuration={3000} animationEasing="linear" type="monotone" dataKey="novos" stroke="hsl(25 95% 53%)" strokeWidth={2} fill="url(#gradNovos)" dot={false}/>
              </AreaChart>
            </ChartContainer>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Card className="border-border bg-card">
            ...
            <CardContent className="flex items-center gap-6">
              <ChartContainer config={{ count: { label: "Consumidores" } }} className="h-[200px] w-[200px] shrink-0">
                <PieChart>
                  <Pie animationBegin={0} animationDuration={3000} animationEasing="linear" data={cidadeDistData} dataKey="count" nameKey="cidade" cx="50%" cy="50%" outerRadius={80} innerRadius={44} paddingAngle={3}>
          ...
          <Card className="border-border bg-card">
            ...
            <CardContent className="flex items-center gap-6">
              <ChartContainer config={{ count: { label: "Consumidores" } }} className="h-[200px] w-[200px] shrink-0">
                <PieChart>
                  <Pie animationBegin={0} animationDuration={3000} animationEasing="linear" data={frequenciaData} dataKey="count" nameKey="name" cx="50%" cy="50%" outerRadius={80} innerRadius={44} paddingAngle={3}>
