...
export default function FinanceiroVisaoGeral() {
  ...
  const statusBadge = (s: string) => {
    const map: Record<string, { cls: string; label: string }> = {
      ...
      enviado:  { cls: "bg-amber-100 dark:bg-amber-500/20 text-amber-800 dark:text-amber-400 border-amber-500 dark:border-amber-500/30", label: "Aguardando" },
          ...
          <CardContent>
            <ChartContainer config={chartConfig} className="h-[300px] w-full">
              <AreaChart data={chartData} margin={{ top: 8, right: 8, bottom: 0, left: 0 }}>
                ...
                <Area animationDuration={1000} animationEasing="ease-in-out" type="monotone" dataKey="receita" stroke="hsl(25 95% 53%)" strokeWidth={2} fill="url(#vg-receita)" dot={false}/>
                <Area animationDuration={1000} animationEasing="ease-in-out" type="monotone" dataKey="custos" stroke="hsl(var(--destructive))" strokeWidth={2} fill="url(#vg-custos)" dot={false}/>
                <Area animationDuration={1000} animationEasing="ease-in-out" type="monotone" dataKey="lucro" stroke="hsl(var(--primary))" strokeWidth={2} fill="url(#vg-lucro)" dot={false}/>
              </AreaChart>
            </ChartContainer>
          </CardContent>
        </Card>
